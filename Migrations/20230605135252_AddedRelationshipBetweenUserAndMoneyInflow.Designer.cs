...
namespace MinhasFinancas.Migrations
{
    ...
    [Migration("20230605135252_AddedRelationshipBetweenUserAndMoneyInflow")]
    partial class AddedRelationshipBetweenUserAndMoneyInflow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MinhasFinancas.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MinhasFinancas.Models.User", b =>
                {
                    b.Navigation("MoneyInflows");

                    b.Navigation("MoneyOutflows");
                });
